...
pub use registry::{color_for, is_belt, is_pipe, is_pipe_to_ground, is_rotation_allowed, is_splitter, underground_reach, is_terrain_scatter, TypeId, TypeRegistry};
...
pub use sprites::{
    belt_source_rect, entity_sheet_candidates, entity_sheet_path, icon_candidates, icon_path, icon_source_rect,
    pipe_piece_path, pipe_to_ground_paths, splitter_offsets, splitter_patch_path, splitter_source_rect, splitter_structure_paths, underground_source_rect, underground_structure_path,
    SPRITE_TILE_PIXELS,
};
